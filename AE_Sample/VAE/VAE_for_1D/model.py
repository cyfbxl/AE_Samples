...
class Base_VAE(nn.Module):
    def __init__(self, args):
        ...
        self.fc_mu = nn.Linear(2048, args.latent_dim)
        self.fc_var = nn.Linear(2048, args.latent_dim)
        self.decoder_input = nn.Linear(args.latent_dim, 2048)
    ...
    def decode(self, z):
        ...
        result = result.view(self.batch_size, 8, -1)
        # print(result.shape)
